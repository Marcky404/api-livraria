...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponse> desativarCliente(@RequestBody @Valid ClienteResponse clienteResponse){
        return ResponseEntity.ok(service.desativarCliente(clienteResponse));
    }
